...
#  if DEF_SDK_VERSION >= 1400	/* SDK >= 1.4.0 */
  uint8_t field_000[8];		/* +000  g_ic+? 464 boot_version // 3FFF0834 */
  uint8_t wfmode[4];		/* +008  g_ic.c[0x1D8] (+472) SDK 1.3.0 // 3FFF083C */
  uint32_t st_ssid_len;		/* +012  g_ic+? */
  ...
  uint32_t phy_mode;		/* +836 // g_ic+1300 (+514h) // 3FFF0B78 */
...
#  elif DEF_SDK_VERSION >= 1299	/* SDK >= 1.3.0 */
  ...
  uint8_t field_878[2];		/* +878 */
  uint32_t field_880;		/* +880 */
  uint32_t field_884;		/* +880 */
#  elif DEF_SDK_VERSION >= 1200	/* SDK >= 1.2.0 */
  uint8_t field_000[8];		/* +000  g_ic+? 488 boot_version // 0x3FFF2530 */
  uint8_t wfmode[4];		/* +008  g_ic.c[0x214] (+532) SDK 1.2.0 // 3FFF2538 */
