...
/* 0x60000700 */
#  define IO_RTC_0        rtc_[0]
				/* bit31 - software_reset() */
...
/* 0x60000708 */
#  define IO_RTC_2        rtc_[2]
				/* bit21 - rtc_get_reset_reason(), bit20 - rtc_enter_sleep() */
/* 0x6000070C */
#  define IO_RTC_3        rtc_[3]
/* 0x60000710 */
#  define IO_RTC_4        rtc_[4]
				/* rtc_enter_sleep() = 0; */
/* IO_RTC_4 = 0 - отключение WiFi
   ...
   0x60000714 */
#  define IO_RTC_5        rtc_[5]
				/* bitrtc_get_reset_reason() */
/* 0x60000718 */
#  define IO_RTC_6        rtc_[6]
				/* bitrtc_get_reset_reason() */
...
#  define VAL_MUX_GPIO1_SDK_DEF 0
				/* UART0, TX0, Outnput */
#  define VAL_MUX_GPIO2_SDK_DEF 0
				/* UART1, TX1, Outnput */
